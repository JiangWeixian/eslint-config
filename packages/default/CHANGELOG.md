...
- 6ba4011: - Allow common uppercase filenames (README.md, FUNDING.yml, Dockerfile, dotfiles) in `unicorn/filename-case`
  - Remove unused `packages/analyze` and `packages/plugin-modular`
  - Remove unused `eslint-plugin-ssr-friendly` type shim

### Patch Changes

- 6ba4011: Add `**/superpowers` to default ignore patterns

## 3.0.2

### Patch Changes

- c945a31: fix: drop CJS build to fix `ERR_PACKAGE_PATH_NOT_EXPORTED` with ESM-only `@eslint-react/eslint-plugin`
...
- 4081c83: Upgrade ESLint to v10 and all plugins to latest versions, add Vitest test system
...
- 67cdb48: add webpackChunkname check
...
- Updated dependencies [ffea08d]
  - @aiou/eslint-config-react@0.6.10
...
- @aiou/eslint-config-react@0.6.7

## 0.7.7

### Patch Changes

- @aiou/eslint-config-react@0.6.6
...
- @aiou/eslint-config-react@0.6.4

## 0.7.4

### Patch Changes

- @aiou/eslint-config-react@0.6.3

## 0.7.3

### Patch Changes

- @aiou/eslint-config-react@0.6.2
